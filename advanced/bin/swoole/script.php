...
class ServerSwoole
{
    ...
    {
        $pid = @file_get_contents('/usr/local/www/testeswoole/advanced/frontend/runtime/swoole/swoole.pid');
        if (empty($pid)) {
    ...
    public function actionStart()
    {
        ...
        shell_exec("php /usr/local/www/testeswoole/advanced/bootstrap.php");
    }
